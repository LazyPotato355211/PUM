...
fun convert(word: String): String {
    val keypad = mapOf( // przypisanie kazdej literze liczb z klawiatury
    ...
    .map { keypad[it] ?: "" } // kazda litera na tekst z mapy, jesli brak litery to pusty tekst
    .joinToString("") // laczenie wszystkiego
}